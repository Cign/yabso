...
<body>
    ...
    <main class="content">
        ...
        <section id="home" class="home d-flex align-items-center">
            <div class="container">
                ...
                <div class="intro">
                    <!-- avatar image -->
                    <img src="images/avatar-1.svg" alt="sayotagt" class="mb-4" />

                    <!-- info -->
                    <h1 class="mb-2 mt-0">Yaya Abdoul SANGARE</h1>
                    <span>Je suis<span class="text-rotating"> Développeur FullStack, Développeur Mobile, Monéticien, Passioné d'informatique, Passionné d' IA</span></span>
                    ...
                    <!-- buttons -->
                    <div class="mt-4">
                        <a href="#contact" class="btn btn-default">Engagez moi</a>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="text-center text-md-left">
                            <!-- avatar image -->
                            <img src="images/avatar-2.svg" alt="sayotagt" />
                        </div>
                    ...
                    <div class="col-md-9 triangle-left-md triangle-top-sm">
                        <div class="rounded bg-white shadow-dark padding-30">
                            <div class="row">
                                <div class="col-md-6">
                                    <!-- about text -->
                                    <p>Je suis Yaya Abdoul SANGARE, développeur mobile à Dakar, Sénégal. J'ai une riche expérience en développement web et mobile, je suis aussi Monéticien.</p>
                                    <div class="mt-3">
                                        <a href="#" class="btn btn-default">Télécharger CV</a>
                                    </div>
                                    <div class="spacer d-md-none d-lg-none" data-height="30"></div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="skill-item">
                                        <div class="skill-info clearfix">
                                            <h4 class="float-left mb-3 mt-0">Dévelopment Mobile</h4>
                                    ...
                                    <div class="skill-item">
                                        <div class="skill-info clearfix">
                                            <h4 class="float-left mb-3 mt-0">FullStack Analyste-Développeur Web </h4>
                                            <span class="float-right">95%</span>
                                        </div>
                                        <div class="progress">
                                    ...
                                    <div class="skill-item">
                                        <div class="skill-info clearfix">
                                            <h4 class="float-left mb-3 mt-0">Monéticien</h4>
                    ...
                    <div class="col-md-3 col-sm-6">
                        ...
                        <div class="fact-item">
                            ...
                            <div class="details">
                                ...
                                <p class="mb-0">Projects accomplis</p>
                            </div>
                        </div>
                        <div class="spacer d-md-none d-lg-none" data-height="30"></div>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        ...
                        <div class="fact-item">
                            ...
                            <div class="details">
                                ...
                                <p class="mb-0">Payez moi un caffé</p>
                            </div>
                        </div>
                        <div class="spacer d-md-none d-lg-none" data-height="30"></div>
                    </div>
        ...
        <section id="services">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="service-box rounded data-background padding-30 text-center text-light shadow-blue" data-color="#6C6CE5">
                            ...
                            <h3 class="mb-3 mt-0">Développement mobile et desktop</h3>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="service-box rounded data-background padding-30 text-center shadow-yellow" data-color="#F9D74C">
                            ...
                            <h3 class="mb-3 mt-0">Développement web</h3>
                            <p class="mb-0">Lorem ipsum dolor sit amet consectetuer adipiscing elit aenean commodo ligula eget.</p>
                        </div>
                        <div class="spacer d-md-none d-lg-none" data-height="30"></div>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="service-box rounded data-background padding-30 text-center text-light shadow-pink" data-color="#F97B8B">
                            ...
                            <h3 class="mb-3 mt-0">Monétique Back Office</h3>
                            <p class="mb-0">Lorem ipsum dolor sit amet consectetuer adipiscing elit aenean commodo ligula eget.</p>
                        </div>
                    </div>
                ...
                <div class="mt-5 text-center">
                    <p class="mb-0">A la recherche d'une application hautement personnalisée ? <a href="#contact">Cliquer ici</a> Contactez moi! 👋</p>
                </div>
                        ...
                        <div class="timeline edu bg-white rounded shadow-dark padding-30 overflow-hidden">
                            ...
                            <div class="timeline-container wow fadeInUp">
                                <div class="content">
                                    ...
                                    <h3 class="title">Monétique Master</h3>
                            ...
                            <div class="timeline-container wow fadeInUp" data-wow-delay="0.2s">
                                <div class="content">
                                    ...
                                    <h3 class="title">Bachelor en Génie logiciel</h3>
                                    <p>Lorem ipsum dolor sit amet quo ei simul congue exerci ad nec admodum perfecto.</p>
                                </div>
                            </div>
                            ...
                            <div class="timeline-container wow fadeInUp" data-wow-delay="0.4s">
                                <div class="content">
                                    ...
                                    <h3 class="title">Baccalauréat</h3>
                                    <p>Lorem ipsum dolor sit amet quo ei simul congue exerci ad nec admodum perfecto.</p>
                                </div>
                            </div>
                        ...
                        <div class="timeline exp bg-white rounded shadow-dark padding-30 overflow-hidden">
                            ...
                            <div class="timeline-container wow fadeInUp" data-wow-delay="0.4s">
                                <div class="content">
                                    ...
                                    <h3 class="title">Freelance Développeur web</h3>
                                    <p>Lorem ipsum dolor sit amet quo ei simul congue exerci ad nec admodum perfecto.</p>
                                </div>
                            </div>
                            ...
                            <div class="timeline-container wow fadeInUp">
                                <div class="content">
                                    ...
                                    <h3 class="title">Dévelloppeur mobile</h3>
                                    <p>Lorem ipsum dolor sit amet quo ei simul congue exerci ad nec admodum perfecto.</p>
                                </div>
                            </div>
                            ...
                            <div class="timeline-container wow fadeInUp" data-wow-delay="0.2s">
                                <div class="content">
                                    ...
                                    <h3 class="title">Analyste-Développeur FullStack</h3>
                                    <p>Lorem ipsum dolor sit amet quo ei simul congue exerci ad nec admodum perfecto.</p>
                                </div>
                            </div>
        ...
        <section id="works">
            ...
            <div class="container">
                ...
                <!-- section title -->
                <h2 class="section-title wow fadeInUp">Travail récent</h2>
                ...
                <div class="row portfolio-wrapper">
                    ...
                    <div class="col-md-4 col-sm-6 grid-item branding">
                        <a href="https://www.youtube.com/watch?v=qf9z4ulfmYw" class="work-video">
                            <div class="portfolio-item rounded shadow-dark">
                                <div class="details">
                                    <span class="term">Projet personnel</span>
                                    <h4 class="title">Managément</h4>
                    ...
                    <div class="col-md-4 col-sm-6 grid-item art branding">
                        <a href="#gallery-1" class="gallery-link">
                            <div class="portfolio-item rounded shadow-dark">
                                <div class="details">
                                    <span class="term">Infographie</span>
                                    <h4 class="title">Design et conception de Logo</h4>
                ...
                <div class="load-more text-center mt-4">
                    <a href="javascript:" class="btn btn-default"><i class="fas fa-spinner"></i> Voir plus</a>
        ...
        <section id="prices">
            ...
            <div class="container">
                ...
                <!-- section title -->
                <h2 class="section-title wow fadeIn">Plans</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 pr-md-0 mt-md-4 mt-0">
                        ...
                        <div class="price-item bg-white rounded shadow-dark text-center">
                            ...
                            <!-- <p>A Simple option but powerful to manage your business Simple, sur mesure pour la gestion de votre business</p> -->
                            <p>Simple et sur mesure pour la maintenance dans votre business</p>
                            <p>Email support</p>
                            <h3 class="price"><em>$</em>9<span>Month</span></h3>
                            <a href="#" class="btn btn-default">Démarrer</a>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 px-md-0 my-4 my-md-0">
                        ...
                        <div class="price-item bg-white rounded shadow-dark text-center best">
                            <span class="badge">Recommendé</span>
                            <img src="images/price-2.svg" alt="Premium" />
                            <h2 class="plan">Premium</h2>
                            <!-- <p>Illimité inclue l'intégration d'application et plus Unlimited product including apps integrations and more features</p> -->
                            <p>Illimité inclue l'intégration d'applications et plus</p>
                            <p>Support technique LUN-VEN</p>
                    ...
                    <div class="col-md-4 pl-md-0 mt-md-4 mt-0">
                        ...
                        <div class="price-item bg-white rounded shadow-dark text-center">
                            ...
                            <h2 class="plan">Ultime</h2>
                            <!-- <p>A wise option for large companies and individuals</p> -->
                            <p>Option judicieuse pour les grandes entreprises et les particliers</p>
                            <p>support 24/7</p>
                        ...
                        <div class="blog-item rounded bg-white shadow-dark wow fadeIn">
                            ...
                            <div class="details">
                                ...
                                <ul class="list-inline meta mb-0 mt-2">
                                    ...
                                    <li class="list-inline-item">sayotagt</li>
                                </ul>
                            </div>
                        </div>
                    </div>
 ...
 <!-- jQuery first, then Popper.js, then Bootstrap JS -->
    ...
    <script src="{{asset('assets/js/custom.js')}}"></script>
     <!-- owl carousel -->
     <script src="{{asset('assets_bis/plugins/js/owl.carousel.js')}}"></script>
     <!-- mixin js-->
     <script src="{{asset('assets_bis/plugins/js/jquery.mixitup.min.js')}}"></script>
     <!-- circle progress-->
     <script src="{{asset('assets_bis/plugins/js/circle-progress.js')}}"></script>
     <!-- jquery nav -->
     <script src="{{asset('assets_bis/plugins/js/jquery.nav.js')}}"></script>
     <!-- Fancybox js-->
     <script src="{{asset('assets_bis/plugins/js/jquery.fancybox.min.js')}}"></script>
     <!-- isotope js-->
     <script src="{{asset('assets_bis/plugins/js/isotope.pkgd.js')}}"></script>
     <script src="{{asset('assets_bis/plugins/js/packery-mode.pkgd.js')}}"></script>
